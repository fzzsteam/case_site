  ...
  return (
    <Reveal delay={index * 70}>
      <article className="aigc-talent-record">
        <Link className="aigc-talent-record__link" href={`/edu/talent/${talent.id}`} aria-label={`查看${talent.name}的人才详情`}>
    ...
    <main id="main-content" className="aigc-market-page">
      <section className="aigc-market-hero" aria-labelledby="talent-market-title">
        <div className="aigc-shell">
          ...
          <div className="aigc-market-hero__grid">
            ...
            <div className="aigc-market-hero__note"><span>MARKET NOTE / 001</span><p>这里不是一份静态名单。每个创作者都从训练作品、项目过程和可合作能力开始建立档案。</p><Link href="/edu#modules">查看训练路径 <ArrowUpRight size={15} /></Link></div>
          </div>
      ...
      <section className="aigc-section aigc-section--market" id="talent-directory" aria-labelledby="talent-directory-title">
        <div className="aigc-shell">
          ...
          <div className="aigc-market-footer"><span>作品集持续更新中 / LIVE ARCHIVE</span><Link href="/edu#modules">返回训练路径 <ArrowUpRight size={15} /></Link></div>
        </div>
      </section>
    </main>
  );
